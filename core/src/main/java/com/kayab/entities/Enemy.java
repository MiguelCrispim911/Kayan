...
public class Enemy {
    ...
    public void update(float delta, Vector2 playerPos) {
        ...
        if (distToPlayer < Constants.ENEMY_DETECTION_RANGE) {
            ...
            if (type == Type.SHIELD) {
                // SHIELD: Avanza lentamente hacia Kayab sin detenerse y NO dispara
                ...
                // BASIC: Se detiene y dispara flechas en rango
